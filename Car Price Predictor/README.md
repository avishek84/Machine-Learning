<p>This dataset contains data which is used to predict the price of a car. Few of the features are - Name of the car, Company that manufactured the car, Price of the car, Kms driven, etc.</p>
